...
### Sequential Thinking
${this.results.realTests.sequential_thinking_1 ? `- **1 concurrent**: ${this.results.realTests.sequential_thinking_1.success ? '✅' : '❌'} (${this.results.realTests.sequential_thinking_1.avgResponseTime?.toFixed(0)}ms avg)` : '- Not tested'}
${this.results.realTests.sequential_thinking_2 ? `- **2 concurrent**: ${this.results.realTests.sequential_thinking_2.success ? '✅' : '❌'} (${this.results.realTests.sequential_thinking_2.avgResponseTime?.toFixed(0)}ms avg)` : '- Not tested'}

### Linear Server
${this.results.realTests.linear_teams_1 ? `- **1 concurrent**: ${this.results.realTests.linear_teams_1.success ? '✅' : '❌'} (${this.results.realTests.linear_teams_1.avgResponseTime?.toFixed(0)}ms avg)` : '- Not tested'}
${this.results.realTests.linear_teams_2 ? `- **2 concurrent**: ${this.results.realTests.linear_teams_2.success ? '✅' : '❌'} (${this.results.realTests.linear_teams_2.avgResponseTime?.toFixed(0)}ms avg)` : '- Not tested'}
